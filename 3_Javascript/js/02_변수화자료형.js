...
// 변수에 대입한 값 변경하기
number1 = 300; // number1에 300 재대입(기존 10값을 덮어쓰기)
...
console.log(test2);
// -> test2도 접근 가능.
// -> 왜? 함수레벨 스코프인 var 는 일반블록은 무시하기 때문에
...
// -> x의 선언이 호이스팅됨. 그러나 TDZ에 놓여 초기화 전까지 접근 불가
// -> 초기화가 이루어지기 전까지 해당 변수는 TDZ에 놓이며,
// 이 기간동안 변수에 접근하려고 하면 Cannot access 'x' before initialization 라는 에러 발생.
...
console.log("numbers 배열 값 중 3번째 : " , numbers[3], typeof numbers[3]); // undefined
